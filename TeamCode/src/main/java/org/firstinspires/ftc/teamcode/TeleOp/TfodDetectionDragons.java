        ...
        while (opModeIsActive())
        {
            ...
            if (currentStep==1)
            {
                if (runtime.milliseconds() < 250) {
                    moveRobot(-3, 0, 0);// originally x was 10, then was 3,
                    // robot seemed move backward, so we tried to make X to negative X
                    // now -3
                    // going too far, changing time from 450ms to 250ms
                }
                else {
                    moveRobot(0, 0, 0);
                    currentStep = 2;
            ...
            if (currentStep==4) {
                //note: I'm setting current step to 31 to exit program after left pixel detection
                //take this out eventually.
                currentStep = 31;
                if (runtime.milliseconds() < 460) {
                    moveRobot(0, 0, 0);//x=5
                    //this was x 1, y 0, yaw 0
                    //make this x 0, y 0, yaw 0
                }
                else {
                    moveRobot(0, 0, 0);
                    currentStep = 5;
            ...
            if (currentStep==6) {
                if (runtime.milliseconds() < 125) {
                    moveRobot(0, 0, 3);
                    //originally was yaw-5
                    //tried yaw negative 1
                    //changed to yaw 1
                    //changed to yaw 2
                    //changed to yaw 3
                }
                else if (runtime.milliseconds() > 125 && runtime.milliseconds() < 250)
                {
                    //move forward
                    moveRobot(-1, 0, 0);
                }
            ...
            //TODO - figure out how to fix this since we don't have a touch sensor.
            if (currentStep==23) {
